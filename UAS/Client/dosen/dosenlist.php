...
<script>
    ...
    gh.onload = function(){
        ...
        for(i=0;i<dta.length;i++){
            ...
            tx +='  <td>'+dta[i][2]+'</td>';
            tx +='  <td> ';
            tx +='<a href="main.php?p=dosen&sp=editdosen&kode='+dta[i][0]+'" class="badge bg-success">edit</a> ';
            tx +='<a href="main.php?p=dosen&sp=deledosen&kode='+dta[i][0]+'" class="badge bg-danger">hapus</a> ';
            tx +='</td>';
            tx +='</tr>';
            nomor++;
        }    
